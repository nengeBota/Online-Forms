const localContentFieldNames = {
  ...
  staffBreakdown: {
    ghanaian: {
      ...
      internsOrNationalService: 'staffBreakdown-ghanaian-InternsOrNationalService',
    },
    foreigners: {
      ...
      internsOrNationalService: 'staffBreakdown-foreign-InternsOrNationalService',
    },
    total: {
      ...
      internsOrNationalService: 'staffBreakdown-total-InternsOrNationalService',
    },
  ...
  servicesReceived: {
    ...
    paymentsReceivedInLast12Months: "servicesReceived-paymentsReceivedInLast12Months",
    isEditing: "isEditing",
  },

  servicesRendered: {
    _: "servicesRendered",
    serviceRecepient: "servicesRendered-serviceRecepient",
    ...
    paymentsReceivedInLast12Months: "servicesRendered-paymentsReceivedInLast12Months",
    isEditing: "isEditing",
  },
  ...
  professionalServicesDetails: {
    insuranceServices: {
      ...
      expenditureInLast12Months: "insuranceServices-expenditureInLast12Months",
    },
    financialServices: {
      serviceProvider: "financialServices-serviceProvider",
      location: "financialServices-location",
      expenditureInLast12Months: "financialServices-expenditureInLast12Months",
    },
    indigenousBanks: {
      serviceProvider: "indigenousBanks-serviceProvider",
      location: "indigenousBanks-location",
      expenditureInLast12Months: "indigenousBanks-expenditureInLast12Months",
    },
    legalServices: {
      serviceProvider: "legalServices-serviceProvider",
      location: "legalServices-location",
      expenditureInLast12Months: "legalServices-expenditureInLast12Months",
    },
  },
